...
const events = {
  'suite:start': '##teamcity[testSuiteStarted flowId=\'[flowId]\' nodeId=\'[flowId]\' parentNodeId=\'0\' name=\'[name]\']',
  'test:start': '##teamcity[testStarted flowId=\'[flowId]\' nodeId=\'[uid]\' parentNodeId=\'[flowId]\' name=\'[name]\' captureStandardOutput=\'[captureStandardOutput]\' locationHint=\'test:/[file]\']',
  'test:end': '##teamcity[testFinished flowId=\'[flowId]\' nodeId=\'[uid]\' parentNodeId=\'[flowId]\' name=\'[name]\']',
  'test:fail': '##teamcity[testFailed flowId=\'[flowId]\' nodeId=\'[uid]\' parentNodeId=\'[flowId]\' name=\'[name]\' message=\'[message]\' details=\'[details]\']',
  'test:pending': '##teamcity[testIgnored flowId=\'[flowId]\' nodeId=\'[uid]\' parentNodeId=\'[flowId]\' name=\'[name]\' message=\'pending\']',
  'suite:end': '##teamcity[testSuiteFinished flowId=\'[flowId]\' nodeId=\'[flowId]\' parentNodeId=\'0\' name=\'[name]\']',
};
